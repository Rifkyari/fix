<?php
	...
	$qflight   = "SELECT * FROM tb_resort ";
	$qflight  .= "WHERE ";
	$qflight  .= "resort_kab LIKE  '".$_GET['resort_kab']."' AND ";
	$qflight  .= "resort_masuk LIKE  '".$_GET['resort_masuk']."'  ";
							...
							<tbody>
								<?php
									while ($row_f = $rstflight->fetch_assoc()) {
										echo"<tr>";
										echo"<td>".$row_f['resort_nama']."</td>";
										echo"<td>".$row_f['resort_masuk']."</td>";
										echo"<td>".$row_f['resort_keluar']."</td>";
										echo"<td>".$row_f['resort_lama']."</td>";
										echo"<td>".$row_f['resort_kab']."</td>";
										echo"<td>IDR ".$row_f['resort_harga']."</td>";
